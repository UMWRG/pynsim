...
# Nodes
R1 = Reservoir(x=0, y=2, name='R1')
R2 = Reservoir(x=0, y=1, name='R2')
R3 = Reservoir(x=2, y=1, name='R3')
R4 = Reservoir(x=1, y=0, name='R4')

# Links
L1 = River(start_node=R1, end_node=R2, name='R1_R2')
L2 = River(start_node=R2, end_node=R4, name='R2_R4')
L3 = River(start_node=R3, end_node=R4, name='R3_R4')
...
print("R4 Depth: {0}".format(network.get_node('R4').get_depth()))
